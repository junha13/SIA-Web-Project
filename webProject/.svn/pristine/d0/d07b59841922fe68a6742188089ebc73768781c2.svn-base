...
<script>
	...
	<div id="postWritePage">
		<div id="post">
			<form class="row g-1" action="update.post" method="post" enctype="multipart/form-data">  <!-- 데이터가 인코딩 되는 방식을 정하는건데 이거는 모든 문자를 인코딩하지 않음 -->
				<input type="hidden" name="pkid" value="${post.pkId}"> 
				<div class="col-6">
					<input id="title" name="title" autocomplete="off" value="${post.postTitle}">
				</div>
				<div class="col-6">
					<input id="location" name="location" autocomplete="off" value="${post.postLocation}">
				...
				<div class="col-2">
					<input type="date" id="startDay" name="startDay" autocomplete="off" value="${post.postStartDay}">
				</div>
				<div class="col-1">
					<span id="text">여행 종료일</span>
				</div>
				<div class="col-2">
					<input type="date" id="endDay" name="endDay" autocomplete="off" value="${post.postEndDay}">
				</div>
				<div class="col-1">
				...
				<div class="col-5">
					...
					<input type="hidden" id="firstThumbnail" name="firstThumbnail" value="${post.postThumbnail}">
				</div>
				<div class="col-12">
				<div class="textBox">
					<textarea id="textBox" name="contentHtml">
						<c:out value ="${post.postContent}" escapeXml="false" /> <!-- escapeXml : 태그문자는 제외하는거임 -->
					</textarea>
				</div>
				</div>
				<div class="col-12">
	...
	$('#post form').on('submit', function (e) {
	    ...
	    const fisrtThumbnail = $('#firstThumbnail').val();
