...
<div class="d-flex flex-column h-100">
	...
	<div v-if="!fullScreen" class="app-header d-flex align-items-center justify-content-between border-bottom bg-white p-2">
		...
		<div class="w-550px d-flex align-self-center">
			<span class=" fs-2 fw-bold">안전등산</span>
		</div>

		<button class="w-100px btn btn-icon btn-light align-self-center" @click="goToLogin()">
...
// 화면이 보이기 전에 한번 호출됨
onMounted(() => {
  console.log(`App : View::onMounted 호출됨.`);
