	...
	<nav class="navbar navbar-expand-sm bg-light navbar-light fixed-top">
		<div class="container">
			...
			<ul class="navbar-nav justify-content-center">
				...
				<li class="nav-item">
					<a class="nav-link" href="${pageContext.request.contextPath}/all.post"><span class="main_menu">모든글보기</span></a>
				</li>
				<!-- user menu -->
				...
				<li class="nav-item" id="login">				
					...
					<c:if test="${not empty sessionScope.loginId}">
					  <a class="main_menu" href="${pageContext.request.contextPath}/post/postWrite.jsp">글쓰기</a>
