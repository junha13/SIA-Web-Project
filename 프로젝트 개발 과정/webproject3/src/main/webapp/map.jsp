...
<body>
	...
	<script>
	    ...
	    var locationUrls = {
	    	    ...
	    	    "대구광역시": contextPath + "/post/location.post?location=daegu",
	    	    "인천광역시": contextPath + "/post/location.post?location=incheon",
	    	    "광주광역시": contextPath + "/post/location.post?location=gwangju",
	    	    "대전광역시": contextPath + "/post/location.post?location=daejeon",
	    	    "울산광역시": contextPath + "/post/location.post?location=ulsan",
	    	    "세종특별자치시": contextPath + "/post/location.post?location=sejong",
	    	    "경기도": contextPath + "/post/location.post?location=gyeonggi",
	    	    "강원도": contextPath + "/post/location.post?location=gangwon",
	    	    "충청북도": contextPath + "/post/location.post?location=chungbuk",
	    	    "충청남도": contextPath + "/post/location.post?location=chungnam",
	    	    "전라북도": contextPath + "/post/location.post?location=jeonbuk",
	    	    "전라남도": contextPath + "/post/location.post?location=jeonnam",
	    	    "경상북도": contextPath + "/post/location.post?location=gyeongbuk",
	    	    "경상남도": contextPath + "/post/location.post?location=gyeongnam",
